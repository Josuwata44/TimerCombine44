...
struct SecondView: View {
    @ObservedObject private var viewModel: SecondViewModel
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading) {
                Blur2View(text: viewModel.name, textSize: 50, startTime: 0.41)
